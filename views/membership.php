...
<div class="main-content bg-white">
    <section class="container my-5">
        <h3 class="panel-title  text-center">MOON LIBRARY</h3>
        <h3 class="text-center mt-5">Membership</h3>
        <div class="table table-responsiven mt-4">
            <table class="table">
                <thead>
                    <tr>
                        <th>NO</th>
        ...
        <a href="/register">
            ...
            <button class="btn btn-sm btn-primary mx-3 mt-3">Add Membership</button>
        </a>
