...
<div class="main-content bg-white">
    <h1 class="d-flex justify-content-center mt-5">PEMINJAMAN BUKU</h1>
    ...
    <H5 class="mt-5 container">BUKU YANG SEDANG DIPINJAM</H1>
    ...
    <form action="/peminjaman" method="POST" class="container mt-5">
        <div class="mb-3">
